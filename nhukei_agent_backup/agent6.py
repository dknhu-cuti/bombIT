...
class Agent:
    ...
    def act(self, obs):
        ...
        if should_hunt and enemies and int(bombs_left) > 0:
            hunt = self._hunt_enemy_action(grid, my_pos, enemies, blocked, danger_at, bomb_radius, int(bombs_left), freedom_map)
        ...
        return self._evaluate_actions(grid, my_pos, enemies,
    blocked,
    danger_soon,
    danger_now,
    valid_actions,
